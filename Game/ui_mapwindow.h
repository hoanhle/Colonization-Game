...
public:
    ...
    QLCDNumber *freeBwNumber;
    QLCDNumber *freeFarmerNumber;
    QLCDNumber *lcdNumber_4;
    QLCDNumber *freeLoggerNumber;
    QLCDNumber *lcdNumber_6;
    QLCDNumber *freeMinerNumber;
    ...
    void setupUi(QMainWindow *MapWindow)
    {
        ...
        freeBwNumber = new QLCDNumber(frame_3);
        freeBwNumber->setObjectName(QString::fromUtf8("freeBwNumber"));
        freeBwNumber->setGeometry(QRect(60, 90, 31, 16));
        freeFarmerNumber = new QLCDNumber(frame_3);
        freeFarmerNumber->setObjectName(QString::fromUtf8("freeFarmerNumber"));
        freeFarmerNumber->setGeometry(QRect(110, 90, 31, 16));
        lcdNumber_4 = new QLCDNumber(frame_3);
        lcdNumber_4->setObjectName(QString::fromUtf8("lcdNumber_4"));
        lcdNumber_4->setGeometry(QRect(110, 70, 31, 16));
        freeLoggerNumber = new QLCDNumber(frame_3);
        freeLoggerNumber->setObjectName(QString::fromUtf8("freeLoggerNumber"));
        freeLoggerNumber->setGeometry(QRect(160, 90, 31, 16));
        ...
        freeMinerNumber = new QLCDNumber(frame_3);
        freeMinerNumber->setObjectName(QString::fromUtf8("freeMinerNumber"));
        freeMinerNumber->setGeometry(QRect(210, 90, 31, 16));
        ...
        quitButton->setGeometry(QRect(670, 510, 101, 31));
    ...
    void retranslateUi(QMainWindow *MapWindow)
    {
        ...
        quitButton->setText(QCoreApplication::translate("MapWindow", "Quit", nullptr));
    } // retranslateUi
